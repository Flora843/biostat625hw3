...
This R package helps users to fit a linear regression model. It calculate some coefficients and carry out some important tests of the existing `stats::lm` function. Besides, it can calculate the confidence interval of estimated beta. However, it can't fit a model without an intercept properly. 
